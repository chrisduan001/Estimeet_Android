...
public class DataHelper {
    ...
    public interface FriendSessionQuery {
        String[] PROJECTION = {
                ...
                SqliteContract.SessionColumns.DATE_UPDATED,
                ...
                SqliteContract.SessionColumns.GEO_COORDINATE
        };
        ...
        int DATE_CREATED = 4;
        int DATE_UPDATED = 5;
        int EXPIRE_MINUTES = 6;
        int SESSION_DISTANCE = 7;
        int SESSION_ETA = 8;
        int SESSION_LOCATION = 9;
        int SESSION_TYPE = 10;
        int SESSION_REQUESTED_TIME = 11;
        int SESSION_TRAVEL_MODE = 12;
        int FRIEND_IMAGE = 13;
        int FRIEND_NAME = 14;
        int FRIEND_ID = 15;
        int WAITING_TIME = 16;
        int GEO_COORDINATE = 17;
    }
}
